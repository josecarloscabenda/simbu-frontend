...
export default function TextArea({ label, error, className, ...props }: TextAreaProps) {
  return (
    <div>
      ...
      <textarea
        className={cn(
          "w-full px-3 py-2.5 rounded-xl border text-sm bg-[var(--color-surface)] text-[var(--color-ink)] outline-none transition resize-none placeholder:text-[var(--color-muted)]",
          error
